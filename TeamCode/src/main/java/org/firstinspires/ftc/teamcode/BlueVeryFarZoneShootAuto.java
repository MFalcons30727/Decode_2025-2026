...
@Autonomous
public class BlueVeryFarZoneShootAuto extends OpMode {
    ...
    private final Pose blueShootingPose = new Pose (62, 14, Math.toRadians(110));
    private final Pose parkBlueGatePose = new Pose (60,35, Math.toRadians(90));
