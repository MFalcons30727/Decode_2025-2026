...
import com.qualcomm.robotcore.hardware.DcMotor;
    ...
    @Autonomous(name="Austin BackwardTest", group="Autonomous")
    public class BackwardTest extends LinearOpMode {
        ...
        private static final double FORWARD_DISTANCE_INCHES = 27; // change at practice, this is just a random placeholder for now
