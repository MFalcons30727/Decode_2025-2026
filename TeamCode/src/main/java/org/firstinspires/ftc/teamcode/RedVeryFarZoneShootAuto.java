...
@Autonomous
public class RedVeryFarZoneShootAuto extends OpMode {
    ...
    private final Pose redShootingPose = new Pose (80, 16, Math.toRadians(65));
    private final Pose parkRedGatePose = new Pose (85,36, Math.toRadians(90));
